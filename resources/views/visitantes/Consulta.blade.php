...
@section('content')
    ...
    <div class="max-w-6xl mx-auto space-y-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            {{-- BUSCADOR --}}
            <form method="GET" action="{{ route('visitantes.consulta') }}" class="w-full md:w-auto">
                <div class="relative">
                    <input type="text" name="nombre" placeholder="Buscar visitante..." value="{{ request('nombre') }}"
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            @empty
                ...
                <div class="col-span-full text-center py-16 text-slate-400">
                    ...
                    <p class="font-bold">No se encontraron visitantes</p>
                </div>
